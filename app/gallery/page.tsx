  ...
  return (
    <main className="w-full px-6 md:px-12 lg:px-20 xl:px-32 py-20 lg:py-28 mx-auto min-h-screen relative overflow-hidden bg-white dark:bg-[#0a0a0a]">
      ...
      <section className="text-center mb-16 relative z-10">
        ...
        >
          ECA <span className="text-slate-500 dark:text-slate-400 font-serif italic font-medium">Gallery</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          Explore the memories captured from our flagship workshops, grueling coding competitions, and community gatherings.
        </motion.p>
      </section>
      ...
      >
        {galleryData.map((event, idx) => (
          <motion.div key={event.slug} variants={itemVariants}>
            <Link href={`/gallery/${event.slug}`} className="block h-full w-full outline-none">
